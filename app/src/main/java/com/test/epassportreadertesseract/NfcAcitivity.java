...
public class NfcAcitivity extends AppCompatActivity {
    ...
    protected void onResume() {
        super.onResume();
        Log.i("onResume ", "AAAAAAAAAAAAAAAAAAAAAAAA");
    ...
    protected void onPause() {
        super.onPause();
        Log.i("onPause ", "BBBBBBBBBBBBBBBBBBBBBBBBB");
    ...
    protected void onNewIntent(Intent intent) {
        ...
        Log.i("onNewIntent ", "CCCCCCCCCCCCCCCCCCCCCC");
    ...
    private void readTextFromMessage(NdefMessage ndefMessage) {
        Log.i("readTextFromMessage ", "CCCCCCCCCCCCCCCCCCCCCC");
...
*/
    ...
    private void enableForegroundDispatchSystem() {
        Log.i("enableForeground", "CCCCCCCCCCCCCCCCCCCCCC");
        Intent intent = new Intent(this, NfcAcitivity.class).addFlags(Intent.FLAG_RECEIVER_REPLACE_PENDING);
